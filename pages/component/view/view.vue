	...
	<view>
		...
		<view class="uni-padding-wrap uni-common-mt">
			<view class="uni-hello-text">
				Flex是Flexible Box的缩写，意为“弹性布局”，用来为盒状模型提供最大的灵活性。当设置display:
			...
			<!--该模板定义了一个水平排列的 Flex 布局容器，
			包含三个子视图，
			分别设置了不同的背景颜色（红色、绿色、蓝色），
			并显示文本内容 "A"、"B"、"C"。
			-->
			<view class="uni-flex uni-row">
				...
				<view class="flex-item uni-bg-green">D</view>
			</view>
			...
			<!--该模板定义了一个垂直排列的 Flex 布局容器，包含三个子视图，分别设置了不同的背景颜色（红色、绿色和蓝色），并显示了字母 A、B 和 C。			-->
